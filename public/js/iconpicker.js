...
(function (a) {
    ...
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(14)], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
    ...
    a.fn.iconpicker = function (b) {
        return this.each(function () {
            ...
            if (!d.data("iconpicker")) {
                d.data("iconpicker", new c(this, (typeof b === "undefined" ? "undefined" : _typeof(b)) === "object" ? b : {}));
            }
        });
    };
